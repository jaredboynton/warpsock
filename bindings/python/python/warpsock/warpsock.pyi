...
from typing import Any, AsyncIterable, AsyncIterator, Dict, Iterable, List, Literal, Optional, Sequence, Tuple
...
class SyncRequestBuilder:
    ...
    def version(self, version: HttpVersion) -> None: ...
    def body(self, body: bytes) -> None: ...
    def body_stream(self, iterable: Iterable[bytes]) -> None: ...
    def json(self, json_str: str) -> None: ...
    def form(self, form_str: str) -> None: ...
