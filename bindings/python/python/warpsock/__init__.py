"""
Warpsock - Python bindings for the Warpsock HTTP client.
...
Async usage:
    ...
    >>>
    >>> async def main():
    ...     client = warpsock.AsyncClient.builder().build()
...
class SyncClientBuilder:
    """Synchronous builder wrapper around the async Warpsock client builder."""
