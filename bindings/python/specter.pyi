...
class SyncClientBuilder:
    """Builder for creating synchronous HTTP clients."""
...
class SyncRequestBuilder:
    ...
    def header(self, key: str, value: str) -> "SyncRequestBuilder": ...
    def headers(self, headers: List[Tuple[str, str]]) -> "SyncRequestBuilder": ...
    def version(self, version: HttpVersion) -> "SyncRequestBuilder": ...
    def body(self, body: bytes) -> "SyncRequestBuilder": ...
    def body_stream(self, async_iterable: AsyncIterable[bytes]) -> None: ...
    def json(self, json_str: str) -> "SyncRequestBuilder": ...
    def form(self, form_str: str) -> "SyncRequestBuilder": ...
...
class SyncClient:
    ...
    @staticmethod
    def builder() -> SyncClientBuilder: ...
    def get(self, url: str) -> SyncRequestBuilder: ...
    def post(self, url: str) -> SyncRequestBuilder: ...
    def put(self, url: str) -> SyncRequestBuilder: ...
    def delete(self, url: str) -> SyncRequestBuilder: ...
    def patch(self, url: str) -> SyncRequestBuilder: ...
    def head(self, url: str) -> SyncRequestBuilder: ...
    def options(self, url: str) -> SyncRequestBuilder: ...
    def request(self, method: str, url: str) -> SyncRequestBuilder: ...
